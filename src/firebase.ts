...
const firebaseConfig = {
  ...
  // Ensure this matches your console dropdown precisely:
...
export const storage = getStorage(app, "gs://service-request-2e06e.firebasestorage.app"); // Explicit bucket binding
