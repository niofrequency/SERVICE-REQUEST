...
export default function TimikaForm({
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      {/* Interactive Flow-Chart Pipeline Layout for Timika (Horizontal Row) */}
      ...
      <div className="w-full bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm space-y-5 relative max-w-full">
        {!isAuthorized && (
